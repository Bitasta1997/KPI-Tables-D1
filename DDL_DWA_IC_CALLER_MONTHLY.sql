...
CREATE TABLE IF NOT EXISTS DTDVTA.DWA_IC_CALLER_MONTHLY_STG1	
(
 NO_OF_IC_CALLER  INT
...
CREATE TABLE IF NOT EXISTS DTDVTA.DWA_IC_CALLER_MONTHLY
(
 NO_OF_IC_CALLER  INT
,IC_OPERATOR  VARCHAR(10)
,MOST_USED_AMPHUR_CODE  VARCHAR(50)
...
PARTITION BY (DTDVTA.DWA_IC_CALLER_MONTHLY.REPORT_DATE);
